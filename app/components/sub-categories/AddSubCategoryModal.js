...
export default function AddSubCategoryModal({ isOpen, onClose }) {
  ...
  const { createSubCategory, isCreating } = useSubCategoryActions();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("حدث خطأ في إضافة الفئة الفرعية. يرجى المحاولة مرة أخرى.");
    }
  };
        ...
        <div className="p-8 pt-12">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex items-center justify-center gap-8 mt-10">
              ...
              >
                {isCreating ? "جاري الإضافة..." : "إضافة فئة فرعية"}
              </button>
            </div>
          </form>
        </div>
